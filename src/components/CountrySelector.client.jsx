        ...
        {({open}) => {
          ...
          return (
            <>
              ...
              <Listbox.Options
                className={`border-t-contrast/30 bg-contrast absolute bottom-12 z-10 grid
                h-48 w-full overflow-y-scroll rounded-t border border-white px-2 py-2
                ...
                {listboxOpen && (
                  <Suspense fallback={<div className="p-2">Loading…</div>}>
                    ...
                    <Countries
                      ...
                      getClassName={(active) => {
                        return `text-primary bg-contrast w-full p-2 transition rounded 
