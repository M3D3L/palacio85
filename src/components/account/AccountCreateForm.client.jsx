  ...
  return (
    <div className="flex justify-center my-24 px-4">
      <div className="max-w-md w-full">
        <h1 className="text-4xl font-texas neonText font-saira text-green-600 bg-black px-2 inline-block">
          crear una cuenta
        </h1>
        <form noValidate className="pt-6 pb-8 mt-4 mb-4" onSubmit={onSubmit}>
          ...
          <div className="mb-3 border border-green-600 shadow-lg bg-black shadow-green-800">
            <input
          ...
          <div className="flex items-center justify-between">
            <button
              className="bg-black hover:bg-green-600 transition-all duration-150 ease-in-out hover:translate-y-[-2px] border-green-600 border-2 text-white shadow-green-600 shadow-md rounded py-2 px-4 focus:shadow-outline block w-full"
              type="submit"
            >
              Crear una cuenta
            </button>
